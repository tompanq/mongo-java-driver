...
public class MapOfMaps extends NestedGenerics {
    ...
    public void setMap(final Map<String, Map<String, Integer>> map) {
        this.map = map;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof MapOfMaps)) {
            return false;
        }

        final MapOfMaps maps = (MapOfMaps) o;
